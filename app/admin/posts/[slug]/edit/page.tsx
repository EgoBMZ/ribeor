...
import { getPostBySlug, updatePost } from "../../../../../lib/firebase/firestore";
...
export default function EditPostPage() {
  ...
  return (
    <div className="w-full flex flex-col gap-6">
      <h1 className="text-3xl font-oswald text-text-primary uppercase tracking-tight">Editar Artículo</h1>
          ...
          <form onSubmit={handleSubmit} className={`flex flex-col gap-6 w-full ${activeTab === "split" ? "xl:w-1/2" : ""}`}>
            ...
            <div className="flex flex-col gap-2">
              ...
              <input 
                ...
                value={currentSlug} 
                disabled
                className="p-4 rounded-lg bg-bg-secondary border border-border-color text-text-meta outline-none opacity-60 cursor-not-allowed font-mono text-sm"
              />
            </div>
